...
public class Inicializador<bolita> extends javax.swing.JFrame implements KeyListener {
	...
	public static void main(String[] args) throws InterruptedException {
		Inicializador<?> frame = new Inicializador<Object>();
	...
	public Inicializador() {
		...
		ImageIcon imagen = new ImageIcon(this.getClass().getClassLoader().getResource("tablero.jpg"));
		Image icon = Toolkit.getDefaultToolkit().getImage(getClass().getClassLoader().getResource("icono.png"));
		setIconImage(icon);
	...
	public void FinJuego() {
		if (golpes > golpes2) {
			JOptionPane.showMessageDialog(this, "El jugador 1 gano", "Fin del Juego", JOptionPane.YES_NO_OPTION);
			System.exit(0);
		} else {
			if (golpes < golpes2) {
				JOptionPane.showMessageDialog(this, "El jugador 2 gano", "Fin del Juego", JOptionPane.YES_NO_OPTION);
				System.exit(0);
			} else {
